    ...
    <section className="sm:px-8 py-8 px-4">
      ...
      >
        ...
        <div className="grid items-center gap-6 md:grid-cols-2">
          <div className="aspect-video overflow-hidden rounded-xl bg-gray-400 dark:bg-gray-800">
            <svg
              viewBox="0 0 400 300"
          ...
          <div>
            <h4 className="mb-2 text-2xl text-black dark:text-white">
              Nairobi
            </h4>
            <p className="mb-4 text-sm text-gray-400 dark:text-gray-50">
              Kenya
            </p>
